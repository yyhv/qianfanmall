package org.linlinjava.qianfanmall.db.service;

import com.github.pagehelper.Page;
import com.github.pagehelper.PageHelper;
import org.linlinjava.qianfanmall.db.dao.LitemallOrderMapper;
import org.linlinjava.qianfanmall.db.dao.OrderMapper;
import org.linlinjava.qianfanmall.db.domain.LitemallOrder;
import org.linlinjava.qianfanmall.db.domain.LitemallOrderExample;
import org.linlinjava.qianfanmall.db.domain.OrderVo;
...
public class LitemallOrderService {
    @Resource
    private LitemallOrderMapper qianfanmallOrderMapper;
    @Resource
    ...
    public Map<Object, Object> orderInfo(Integer userId) {
        LitemallOrderExample example = new LitemallOrderExample();
        example.or().andUserIdEqualTo(userId).andDeletedEqualTo(false);
        List<LitemallOrder> orders = qianfanmallOrderMapper.selectByExampleSelective(example, LitemallOrder.Column.orderStatus, LitemallOrder.Column.comments);
